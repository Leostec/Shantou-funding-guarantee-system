...
CREATE TABLE IF NOT EXISTS loan_application (
    ...
    analysis_profit_destination TEXT,
...
const mainColumns = [
    ...
    'analysis_fin_net_assets', 'analysis_fin_revenue', 'analysis_fin_net_income', 'analysis_profit_destination',
    'analysis_ind_asset_debt_ratio',
    ...
    'is_table_s1', 'is_table_s2', 'is_table_s3', 'is_table_sales_list_json', 'is_table_s_total', 'is_table_material_cost',
...
const mapMainValues = (payload) => {
    ...
    return [
        ...
        analysis.profit_destination || null,
        ...
        isTable.s2 || null,
        isTable.s3 || null,
        serializeArray(isTable.sales_list || []),
